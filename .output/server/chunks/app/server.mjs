import { version, defineComponent, hasInjectionContext, getCurrentInstance, computed, ref, h, resolveComponent, useSSRContext, createApp, reactive, mergeProps, withCtx, unref, createTextVNode, toDisplayString, createVNode, inject, watchEffect, watch, provide, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, Suspense, nextTick, Transition } from 'vue';
...
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-5d2306f8.mjs').then((m) => m.default || m)
  },
  {
    name: "privacy",
    path: "/privacy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/privacy-15820941.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/terms-and-conditions-9ace672f.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  "default-no-header": () => import('./_nuxt/default-no-header-995f550f.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-5c13577f.mjs').then((m) => m.default || m)
};
...
const _imports_0 = "" + __publicAssetsURL("icon/error.png");
const _sfc_main$1 = {
  __name: "error",
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "default" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_Title, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`错误 - ${ssrInterpolate(unref(SITE_NAME))}`);
                      } else {
                        return [
                          createTextVNode("错误 - " + toDisplayString(unref(SITE_NAME)), 1)
                        ];
                      }
                    }),
                    _: 1
            ...
            _push2(`<div class="container" data-v-eb3ee660${_scopeId}><h1 class="error-title" data-v-eb3ee660${_scopeId}><img class="error-icon"${ssrRenderAttr("src", _imports_0)} data-v-eb3ee660${_scopeId}> 错误 </h1><p class="error-reason" data-v-eb3ee660${_scopeId}>${ssrInterpolate(unref(errorReason))}</p>`);
            ...
            return [
              ...
              createVNode("div", { class: "container" }, [
                createVNode("h1", { class: "error-title" }, [
                  createVNode("img", {
                    class: "error-icon",
                    src: _imports_0
                  }),
                ...
                createVNode("p", { class: "error-reason" }, toDisplayString(unref(errorReason)), 1),
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-eb3ee660"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export { Head as H, Title as T, _export_sfc as _, __nuxt_component_0$1 as a, createError as c, entry$1 as default, useRuntimeConfig as u };
